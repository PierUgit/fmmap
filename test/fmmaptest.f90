...
print*, "Testing FMMAP_SCRATCH - 1000   1000.0 should be printed"
...
print*, "Testing FMMAP_NEW - 1000   500 should be printed"
...
print*, "Testing FMMAP_OLD - 1000   500 should be printed"
